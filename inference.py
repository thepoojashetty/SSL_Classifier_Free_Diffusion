...
def sample_n_images(n_images, diffusor, model,store_path):
    ...
    plt.imsave(store_path+"all_w11.png", np.transpose(final_img, (1, 2, 0)))

if __name__=="__main__":
    model=UNet.load_from_checkpoint(config.CKPT_DIR_PATH+"/modelA_val_loss(val_loss=0.09)_epoch(epoch=49).ckpt")
    n_images=50
